...
with LF line endings. The archives in the respository contain the same files but with
text files formatted to use CR/LF line endings.

All files in this archive are formatted <repo>-<release tag>.zip
